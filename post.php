...
$message .= '<p style="color:rgba(0, 0, 0, 0.3); font-size:12px;"> Hacked by xxxmxx <a href="mailto:aturosandaval@gmail.com?Subject=Hello%20again">contact</a></p>';
